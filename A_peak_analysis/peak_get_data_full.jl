...
for σ in sigmas_to_run
    ...
    filename = joinpath(@__DIR__, "data_for_peaks_full", "data_$(sigma_str).jld2")
    ...
    # Initialise MPS and MPO arrays with `missing` to prevent save crashes
