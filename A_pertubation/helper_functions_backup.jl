...
#   - Generating random weighted adjacency matrices
#   - Creating XXZ Hamiltonian MPOs
#   - Running DMRG to find ground states
#   - Creating and caching MPS structures
#   - Saving/loading MPS with parameters to/from HDF5 files
